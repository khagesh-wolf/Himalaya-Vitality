...
import { CheckCircle2, XCircle, ArrowRight, Zap, Activity, ShieldCheck, Award, Mountain, Droplet, Globe, Lock, Instagram, Star, Truck, Loader2, AlertTriangle } from 'lucide-react';
  ...
  if (error || !product) {
      return (
          <div className="min-h-screen flex flex-col items-center justify-center bg-white p-4 text-center">
              ...
              <h1 className="text-2xl font-bold text-brand-dark mb-4">Database Connection Failed</h1>
              <p className="text-gray-500 max-w-md mb-6">Could not fetch product data. Please ensure the backend server is running and connected to the database.</p>
                ...
                {[
                  ...
                  <Reveal key={i} delay={i * 100}>
                    <div className="flex flex-col md:flex-row items-center justify-center gap-3 md:gap-4 text-center md:text-left group cursor-default hover:-translate-y-1 transition-transform duration-300 h-full">
                        ...
                        <div>
                            {/* Changed from h4 to div/span for better semantic hierarchy as this isn't a titled section */}
                            <div className="font-heading font-bold text-sm text-brand-dark uppercase tracking-wide group-hover:text-brand-red transition-colors">{item.title}</div>
