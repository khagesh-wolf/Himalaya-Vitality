...
export const CookieConsent = () => {
  ...
  useEffect(() => {
    const consent = localStorage.getItem('himalaya_cookie_consent');
    if (!consent) {
  ...
  const handleAccept = () => {
    localStorage.setItem('himalaya_cookie_consent', 'accepted');
    setIsVisible(false);
  };

  const handleDecline = () => {
    localStorage.setItem('himalaya_cookie_consent', 'declined');
    setIsVisible(false);
  };
